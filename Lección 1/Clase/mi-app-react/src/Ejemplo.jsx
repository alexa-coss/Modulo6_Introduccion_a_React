...
function Ejemplo(objProps) { /* Recibimos un objeto con esos atributos */
    /* Desestructuración de un Arreglo */
    const [count, setCount] = useState(0) /* Importa el orden */

    console.log("PROPS: ", objProps)
    const { list: lista, dummy: cadena, miParametro } = objProps /* Se  puede llamar de diferente manera al desestructurar (nombre = clave) */ /* No importa el orden */
