...
function App() {
  ...
  const agregarFruta = () => {
    ...
    /* miArray.push("sandia"); // Manipular directamente de variable. NO!
     console.log(miArray); // Comprobar: agrega, el navegador no se entera (virtual DOM). | ctrl + s -> ya se ven (Vite).
     setMiArray(miArray); */

    const nuevoArray = [...miArray, "sandia"]; // Mando una copia, no el estado.
