...
export function EjemploMemo({ items }) { // Recibe props -> un arreglo de elementos.
    ...
    /* // Mala práctica, se vuelve complejo y al quitar el filtro no regresa el arreglo orignal con todo.
